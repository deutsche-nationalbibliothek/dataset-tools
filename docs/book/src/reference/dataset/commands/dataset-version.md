...
*dataset-version* --- Get or set the version of the dataset

## SYNOPSIS

`dataset version` [_OPTIONS_] [_VERSION_]

## DESCRIPTION

This command reads or updates the version of the dataset.
...
The following command prints the current dataset version:
...
```console
$ dataset version --bump major # 0.1.0 -> 1.0.0
$ dataset version --bump minor # 0.1.0 -> 0.2.0
$ dataset version --bump patch # 0.1.0 -> 0.1.1
```
